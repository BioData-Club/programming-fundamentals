...
We saw in a previous episode how conditionals work. 
We can use them to check for the suspicious features we see in our inflammation data.
...
~~~
data = numpy.loadtxt(fname='bdc-python/data/inflammation-03.csv', delimiter=',')
