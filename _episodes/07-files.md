...
~~~
print(glob.glob('bdc-python/data/inflammation*.csv'))
~~~
{: .language-python}
...
filenames = sorted(glob.glob('bdc-python/data/inflammation*.csv'))
...
>
> ~~~
> filenames = glob.glob('bdc-python/data/inflammation*.csv')
